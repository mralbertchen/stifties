...
// Generate orders
create_tokens_1
  .createTokens(constants_1.stickers.length)
    ...
    for (var i = 0; i < constants_1.stickers.length; i++) {
      ...
      create_order_1
        .createOrder(
          ...
          10,
          tokenList[i],
          constants_1.stickers[i]
        )
        .then(function(res) {
          return orders.push(res);
        });
    }
  });
// HTTP Serverss
...
app.get("/v0/portfolio/:address", function(req, res) {
...
app.post("/v0/fillorder/", function(req, res) {
  return __awaiter(_this, void 0, void 0, function() {
    ...
    return __generator(this, function(_b) {
      switch (_b.label) {
        ...
        case 1:
          _b.trys.push([1, 3, , 4]);
          orderIndex = orders.findIndex(function(obj) {
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            print_utils_1.findERC721Owner(
              dummyERC721TokenContract,
              new utils_1.BigNumber(constants_1.stickers[i].id)
            )
          ];
        case 2:
          temp = _a.sent();
        ...
        case 4:
          portfolio = owners
            .map(function(element) {
              return element.owner === address ? element.tokenId : undefined;
            })
            .filter(function(obj) {
              return obj;
            });
          return [
            2 /*return*/,
            constants_1.stickers.filter(function(obj) {
              return portfolio.includes(obj.id);
            })
          ];
      }
    });
