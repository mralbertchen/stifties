...
function scenario() {
    return __awaiter(this, void 0, void 0, function () {
        var zeroEx, _a, maker, taker, makerAssetAmount, takerAssetAmount, makerAssetData, takerAssetData, txHash, txReceipt, makerZRXApprovalTxHash, tenMinutes, randomExpiration, exchangeAddress, order, erc20ProxyAddress, orderHashHex, ecSignature, signature;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    print_utils_1.printScenario('Forwarder Buy Tokens');
                ...
                case 3:
                    ...
                    print_utils_1.printData('Setup', [['Maker ZRX Approval', makerZRXApprovalTxHash]]);
