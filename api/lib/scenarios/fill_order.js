...
function scenario() {
    return __awaiter(this, void 0, void 0, function () {
        var zeroEx, _a, maker, taker, makerAssetAmount, takerAssetAmount, etherTokenAddress, makerAssetData, takerAssetData, txHash, txReceipt, makerZRXApprovalTxHash, takerWETHApprovalTxHash, takerWETHDepositTxHash, tenMinutes, randomExpiration, exchangeAddress, order, erc20ProxyAddress, orderHashHex, ecSignature, signature, signedOrder;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    print_utils_1.printScenario('Fill Order');
