...
function scenario() {
    return __awaiter(this, void 0, void 0, function () {
        var dummyERC721TokenContract, zeroEx, _a, maker, taker, makerAssetAmount, takerAssetAmount, tokenId, makerAssetData, etherTokenAddress, takerAssetData, txHash, txReceipt, i, tempNum, _b, _c, mintTxHash, makerERC721ApprovalTxHash, takerWETHApprovalTxHash, takerWETHDepositTxHash, tenMinutes, randomExpiration, exchangeAddress, order, erc20ProxyAddress, orderHashHex, ecSignature, signature, signedOrder;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _a = _d.sent(), maker = _a[0], taker = _a[1];
                ...
                case 4:
                    i++;
                    return [3 /*break*/, 2];
                case 5: return [4 /*yield*/, dummyERC721TokenContract.mint.sendTransactionAsync(maker, tokenId, { from: maker })];
                case 6:
                    mintTxHash = _d.sent();
                ...
                case 8:
                    makerERC721ApprovalTxHash = _d.sent();
                ...
                case 10:
                    takerWETHApprovalTxHash = _d.sent();
                ...
                case 12:
                    takerWETHDepositTxHash = _d.sent();
