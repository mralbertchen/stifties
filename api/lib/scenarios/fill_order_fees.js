...
function scenario() {
    return __awaiter(this, void 0, void 0, function () {
        var zeroEx, _a, maker, taker, feeRecipient, makerAssetAmount, takerAssetAmount, makerFee, takerFee, makerAssetData, takerAssetData, txHash, txReceipt, makerZRXApprovalTxHash, takerZRXApprovalTxHash, takerWETHApprovalTxHash, takerWETHDepositTxHash, tenMinutes, randomExpiration, exchangeAddress, order, erc20ProxyAddress, orderHashHex, ecSignature, signature, signedOrder;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    print_utils_1.printScenario('Fill Order with Fees');
                ...
                case 1:
                    ...
                    print_utils_1.printData('Accounts', [['Maker', maker], ['Taker', taker], ['Fee Recipient', feeRecipient]]);
                    ...
                    return [4 /*yield*/, zeroEx.erc20Token.setUnlimitedProxyAllowanceAsync(contracts_1.zrxTokenContract.address, maker)];
                case 2:
                ...
                case 3:
                    txReceipt = _b.sent();
                    return [4 /*yield*/, zeroEx.erc20Token.setUnlimitedProxyAllowanceAsync(contracts_1.zrxTokenContract.address, taker)];
                case 4:
                ...
                case 5:
                    txReceipt = _b.sent();
                    return [4 /*yield*/, zeroEx.erc20Token.setUnlimitedProxyAllowanceAsync(contracts_1.etherTokenContract.address, taker)];
                case 6:
                ...
                case 7:
                    txReceipt = _b.sent();
                    return [4 /*yield*/, zeroEx.etherToken.depositAsync(contracts_1.etherTokenContract.address, takerAssetAmount, taker)];
                case 8:
                ...
                case 10:
                    _b.sent();
                    return [4 /*yield*/, print_utils_1.fetchAndPrintBalancesAsync({ maker: maker, taker: taker, feeRecipient: feeRecipient }, [contracts_1.zrxTokenContract, contracts_1.etherTokenContract])];
                case 11:
                    _b.sent();
                ...
                case 12:
                    ...
                    return [4 /*yield*/, zeroEx.exchange.fillOrderAsync(signedOrder, takerAssetAmount, taker)];
                case 13:
                ...
                case 14:
                    txReceipt = _b.sent();
                    print_utils_1.printTransaction('fillOrder', txReceipt, [
